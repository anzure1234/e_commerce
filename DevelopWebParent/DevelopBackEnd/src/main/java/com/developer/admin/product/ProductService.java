...
import com.developer.admin.constraint.OrderDetailConstraintRepository;
...
public class ProductService {
	...
	@Autowired private OrderDetailConstraintRepository detailConstraintRepo;
	...
	public void delete(Integer id) throws ProductNotFoundException {
		/*
		 * Long countById = repo.countById(id); if (countById == null || countById == 0)
		...
		List<OrderDetail> details = detailConstraintRepo.findByProduct(product);
		detailConstraintRepo.deleteAll(details);
