...
import com.developer.admin.constraint.BrandContraintRepository;
...
public class CategoryService {
	...
	@Autowired
	private BrandContraintRepository brandRepo;
	@Autowired
	...
	public void delete(Integer id) throws CategoryNotFoundException{
		...
		brandRepo.deleteAllByCategoryId(id);
		
		pdtRepo.deleteAllByCategoryId(id);
		repo.deleteById(id);
